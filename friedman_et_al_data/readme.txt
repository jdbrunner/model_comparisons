All the data in the files listed below is given in units of OD. It was computed by multiplying the total culture OD by the fractions of each species.

The total culture OD was measured on a Variskan plate reader. Fractions were determined separately by plating and colony counting. 
...
-Each pair is competed in duplicate, from two different initial densities. 
Not all initial conditions/replicates are available for all pairs.
...
-Each trio is competed in duplicate, from three different initial densities. 
Not all initial conditions/replicates are available for all trios.

-Data for each trio is given in a different sheet.
-Within a sheet, rows correspond to sampling times (end of growth cycles), and columns to species. 
Different initial conditions/replicate are separated by blank rows.
...
-The sheet named 'all_species' contains the outcomes of competing all eight species.
